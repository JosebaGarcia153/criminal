                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link" href="views/frontoffice/preguntas">
                                <div class="sb-nav-link-icon"><i class="fa fa-check-square-o"></i></div>
                                Preguntas Aprobadas
                            </a>
                            <a class="nav-link" href="views/frontoffice/preguntas?aprobadas=0">
                                <div class="sb-nav-link-icon"><i class="fa fa-check-circle-o"></i></div>
                                Pendientes de Aprobar
                            </a>
                            <a class="nav-link" href="views/frontoffice/agregar-pregunta">
