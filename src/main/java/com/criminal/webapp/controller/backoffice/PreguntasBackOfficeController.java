 ...
 */
@WebServlet("/views/backoffice/preguntas")
public class PreguntasBackOfficeController extends HttpServlet {
		private static final long serialVersionUID = 1L;
		
		private static final Logger LOG = Logger.getLogger(PreguntasBackOfficeController.class);
